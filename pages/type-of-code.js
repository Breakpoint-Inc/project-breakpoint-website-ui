        ...
        <div className="div-block-327">
          ...
          <div className="div-block-328 aaa bbb new-100">
            ...
            <div className="wrap-section1-mu aaa aaaaa min-height-80vh">
              <h1 className="heading-153">How Do You Want To Upload Designs?</h1>
              <div className="div-block-388 auto">
                <div className="div-block-389 _100"><img src="images/Group-33804.svg" loading="lazy" alt="" className="image-102" />
                  <p className="paragraph-6">Code</p>
                </div>
                <div className="div-block-389 _100"><img src="images/Group-33805.svg" loading="lazy" alt="" className="image-102" />
                  <p className="paragraph-6">Code</p>
                </div>
                <div className="div-block-389 _100"><img src="images/Group-33806.svg" loading="lazy" alt="" className="image-102" />
                  <p className="paragraph-6">Code</p>
                </div>
                <div className="div-block-389 _100"><img src="images/Group-1000001851.svg" loading="lazy" alt="" className="image-102" />
                  <p className="paragraph-6">Code</p>
                </div>
              </div>
            </div>
...
export const getStaticProps = async () => {
  const markdownWithMetadata = fs
    .readFileSync("public/content/typeOfCode.md")
    .toString();
