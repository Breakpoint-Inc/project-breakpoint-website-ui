        ...
        <div className="div-block-327">
          ...
          <div className="div-block-328 aaa bbb new-100">
            ...
            <div className="wrap-section1-mu aaa aaaaa min-height-80vh">
              <div className="div-block-385 width-730">
                <h1 className="heading-151">Name YOUR Project</h1>
                <div className="form-block-9 w-form">
                  <form id="email-form" name="email-form" data-name="Email Form" method="get"><label htmlFor="Name-for-the-Project" className="field-label-21">Name for the project</label><input type="text" className="text-field-8 w-input" maxLength={256} name="Name-for-the-Project" data-name="Name for the Project" placeholder="Name for the Project" id="Name-for-the-Project" /><input type="submit" defaultValue="Continue" data-wait="Please wait..." className="submit-button-4 blue w-button" /></form>
...
export const getStaticProps = async () => {
  const markdownWithMetadata = fs
    .readFileSync("public/content/nameYourProduct.md")
    .toString();
...
export default nameYourProduct;
