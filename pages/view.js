        ...
        <div className="dashboard-div">
          ...
          <div className="div-block-327">
            ...
            <div className="div-block-328 aaa bbb new-100">
              ...
              <div className="content-wrapper lll">
                <div className="div-block-165 aaa">
                  <div className="div-block-166">
                    <p className="paragraph-4">1240px</p><img src="images/akar-icons_desktop-device_1.svg" loading="lazy" alt="" className="respons-image" /><img src="images/akar-icons_tablet-device_1.svg" loading="lazy" alt="" className="respons-image" /><img src="images/akar-icons_mobile-device.svg" loading="lazy" alt="" className="respons-image" /><img src="images/mobile-icon.svg" loading="lazy" alt="" />
                  </div>
                  <div className="div-block-167"><img src="images/Homepage-v1-1.png" loading="lazy" srcSet="images/Homepage-v1-1-p-500.png 500w, images/Homepage-v1-1-p-800.png 800w, images/Homepage-v1-1-p-1080.png 1080w, images/Homepage-v1-1.png 1446w" sizes="(max-width: 479px) 90vw, (max-width: 767px) 93vw, (max-width: 991px) 90vw, (max-width: 1279px) 89vw, (max-width: 1439px) 90vw, (max-width: 1919px) 92vw, 97vw" alt="" className="image-70" /></div>
                </div>
              </div>
            </div>
          </div>
        </div>
        <div className="export-code-popup hide">
          <div className="div-block-445">
            ...
            <div data-current="Tab 2" data-easing="ease" data-duration-in={300} data-duration-out={100} className="w-tabs">
              ...
              <div className="tabs-content-2 w-tab-content">
                <div data-w-tab="Tab 2" className="w-tab-pane w--tab-active"><img src="images/Frame-38.png" loading="lazy" srcSet="images/Frame-38-p-500.png 500w, images/Frame-38.png 600w" sizes="100vw" alt="" className="image-70" /></div>
                <div data-w-tab="Tab 3" className="w-tab-pane"><img src="images/Frame-38.png" loading="lazy" srcSet="images/Frame-38-p-500.png 500w, images/Frame-38.png 600w" sizes="100vw" alt="" className="image-70" /></div>
                <div data-w-tab="Tab 4" className="w-tab-pane"><img src="images/Frame-38.png" loading="lazy" srcSet="images/Frame-38-p-500.png 500w, images/Frame-38.png 600w" sizes="100vw" alt="" className="image-70" /></div>
                <div data-w-tab="Tab 5" className="w-tab-pane"><img src="images/Frame-38.png" loading="lazy" srcSet="images/Frame-38-p-500.png 500w, images/Frame-38.png 600w" sizes="100vw" alt="" className="image-70" /></div>
              </div>
            </div>
...
export const getStaticProps = async () => {
  const markdownWithMetadata = fs
    .readFileSync("public/content/view.md")
    .toString();
